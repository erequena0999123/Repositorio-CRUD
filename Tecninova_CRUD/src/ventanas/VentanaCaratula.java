...
public class VentanaCaratula extends JFrame {
	...
	public VentanaCaratula() {
		...
		etiquetaIcono.setIcon(new ImageIcon(VentanaCaratula.class.getResource("/Imagenes/logo.png")));
		...
		JLabel etiquetaCar08 = new JLabel("DESARROLLAR E IMPLEMENTAR UN CRUD CON");
		etiquetaCar08.setFont(new Font("Times New Roman", Font.BOLD, 20));
		etiquetaCar08.setBounds(60, 278, 478, 22);
		contentPane.add(etiquetaCar08);
		
		JLabel etiquetaCar09 = new JLabel("POSTGRESQL, BASADO EN PROGRAMACIÓN JAVA");
		etiquetaCar09.setFont(new Font("Times New Roman", Font.BOLD, 20));
		etiquetaCar09.setBounds(44, 296, 504, 22);
		...
		etiquetaCar11.setBounds(147, 386, 340, 16);
		...
		etiquetaCar12.setBounds(147, 421, 304, 18);
		...
		etiquetaCar13.setBounds(147, 403, 283, 18);
		...
		JLabel etiquetaCar15 = new JLabel("Ing. Moncayo Mosquera Guido Armando");
		etiquetaCar15.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		etiquetaCar15.setBounds(147, 488, 352, 22);
		...
		JLabel lblNewLabel = new JLabel("PARA LA EMPRESA TECNINOVA");
		lblNewLabel.setFont(new Font("Times New Roman", Font.BOLD, 20));
		lblNewLabel.setBounds(136, 315, 320, 22);
